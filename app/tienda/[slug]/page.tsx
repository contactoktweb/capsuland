...
import { products, getProductBySlug, getMainImage } from "@/lib/products"
...
export default function ProductDetailPage() {
  ...
  const currentImage = product.gallery.length > 0 ? product.gallery[selectedImage] : mainImage
            ...
            >
              ...
              <div
                className={`relative aspect-square bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl overflow-hidden mb-4 ${
                  product.gallery.length > 0 ? "cursor-pointer" : ""
                }`}
                onClick={() => product.gallery.length > 0 && setGalleryOpen(true)}
              >
                {currentImage ? (
                  <Image
                    src={currentImage}
